    ...
    public void run()
    {
        ...
        try
        {
            ...
            if (currencyMap.isEmpty())
            {
                ...
                JsonObject currencyListResult = Json.createReader(new StringReader(exampleCurrencyResult)).readObject();
            ...
            //JsonObject exchangeRateResult = UrlUtil.getJsonUrl(currencyLiveApiUrl, accessKey, UrlUtil.toStringKeys(currencyMap));
